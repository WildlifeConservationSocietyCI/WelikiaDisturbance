...
#TODO
- Combine and improve settings (settings_template.py must be copied in and customized on each computer)
- Refactor dir structure
- Assure inputs for FARSITE are in the same directory
