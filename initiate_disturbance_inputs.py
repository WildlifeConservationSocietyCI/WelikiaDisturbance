...
ECOCOMMUNITIES = os.path.join(s.ROOT_DIR, '_inputs_full_extent', 'Welikia_Ecocommunities',
                              'Welikia_Ecocommunities_int.tif')
...
if arcpy.Exists(os.path.join(INPUT_DIR, 'ecocommunities.tif')) is False:
    ...
    arcpy.PolygonToRaster_conversion(in_features=BUFFER,
