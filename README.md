...
##### General
  ...
  - welikia_community_table_int.csv (in tables)

##### Tree Allometery
  - site_index_curve_table.csv (in tables)
  - dbh_lookup.csv (in tables)
  - basal_area_growth_coeffecients.csv (in tables)

##### Fire Tables
  - custom_fuel.fmd (in \tables\fire)
  - fuel_adjustment.adj (in \tables\fire)
  - fuel_moisture.fms (in \tables\fire)
  - wtr record (in \tables\fire)
  - wind.wnd (in \tables\fire)
  - mannahatta-psdi.txt (in \tables\fire)
  - psdi-years.txt (in \tables\fire)
...
##### Fire Spatial Data
  - aspect.asc (\data\TRIAL_NAME\inputs\fire)
  - dem.asc (\data\TRIAL_NAME\inputs\fire)
  - slope.asc (\data\TRIAL_NAME\inputs\fire)
  - canopy.asc (?)
  - fuel.asc (?)
  - fire_trails.asc 
  - hunting_sites.asc 
...
##### Garden Spatial Data
  - garden_sites.shp (in garden_sites)
  - proximity_suitability.tif (TEMP_DIR)
  - slope_suitability.tif (TEMP_DIR)
  
##### Pond Spatial Data
  - dem.tif (TEMP_DIR)
  - flow_direction.tif (TEMP_DIR)
  - stream_suitability.tif (TEMP_DIR)
