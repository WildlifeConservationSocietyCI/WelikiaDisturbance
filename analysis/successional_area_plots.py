...
ax1.plot(x, df_day[str(s.SUCCESSIONAL_GRASSLAND_ID)], color='tomato')
...
ax2.plot(x, df_russell[str(s.SUCCESSIONAL_GRASSLAND_ID)], color='tomato')
plt.ylabel('area $5m^2$')
# ax1.plot(x, d15_ecosystem_area_df[str(s.SHRUBLAND_ID)])
...
ax3.plot(x, df_day_2[str(s.SUCCESSIONAL_GRASSLAND_ID)], color='tomato')
plt.ylabel('area $5m^2$')
# ax1.plot(x, d15_ecosystem_area_df[str(s.SHRUBLAND_ID)])
...
ax4.plot(x, df_russell_2[str(s.SUCCESSIONAL_GRASSLAND_ID)], color='tomato', label='grassland')
plt.ylabel('area $5m^2$')
plt.xlabel('year')
